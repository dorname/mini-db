...
mod tests {
    ...
    fn test_bincode() {
        ...
        let (decoded_u8, _): (u8, _) =
            bincode::decode_from_slice(&encoded_u8, bincode::config::standard()).unwrap();
        ...
        let (decoded_u16, _): (u16, _) =
            bincode::decode_from_slice(&encoded_u16, bincode::config::standard()).unwrap();
